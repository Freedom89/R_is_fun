...
To see the libraries available by [date](https://cran.r-project.org/web/packages/available_packages_by_date.html) or by [name](https://cran.r-project.org/web/packages/available_packages_by_name.html).
